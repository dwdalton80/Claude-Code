...
exports.sm2Update = sm2Update;
exports.scoreToGrade = scoreToGrade;
exports.daysUntilReview = daysUntilReview;
function sm2Update(card, qualityGrade) {
    // Clamp grade to 0-5
    ...
    const efDelta = Math.round((10 - (5 - q) * (8 + (5 - q) * 2))); // * 100 scale: 0.1 -> 10, etc.
 ...
 */
function scoreToGrade(percentCorrect) {
    if (percentCorrect >= 1.0)
        return 5;
    if (percentCorrect >= 0.95)
        return 4;
...
//# sourceMappingURL=sm2_algorithm.js.map